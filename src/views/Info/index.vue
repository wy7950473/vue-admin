<template>
  <div>
    ...
    <el-table-column type="selection" width="40">
      ...
      <el-table-column prop="title" label="标题" width="330"></el-table-column>
...
export default {
  ...
  setup(props, { root }) {
    ...
    return {
      // reactive
      options,tableData, searchOptions,
      // ref
      categoryValue,dateValue,search_key,search_keyWord,dialogInfo,
      // method
      handleSizeChange,handleCurrentChange,close
    };
  }
};
</script>
